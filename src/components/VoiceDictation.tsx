      ...
      <DialogContent className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
            ...
            {hasSpeechApi ? (
              <div className="text-center py-8">
                <p className="text-sm text-muted-foreground mb-6">
                  Click the button to start dictating. Speak naturally — AI will structure your dictation into a SOAP note.
                </p>
              ...
              <div className="space-y-3">
                <p className="text-sm text-muted-foreground">
                  Your browser doesn't support voice recognition. Type or paste your dictation below and AI will still structure it.
                </p>
                <Textarea
                  value={transcript}
        ...
        {stage === "processing" && (
          <div className="text-center py-12 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              AI is structuring your dictation into a SOAP note...
            </p>
        ...
        {stage === "review" && note && (
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Review and edit the structured note before saving.
            </p>
            ...
            <div className="grid gap-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNoteField("note_type", e.target.value)}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateNoteField("chief_complaint", e.target.value)}
                    className="w-full h-8 rounded-md border border-input bg-background px-2 text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateNoteField("follow_up_instructions", e.target.value)}
                  className="w-full h-8 rounded-md border border-input bg-background px-2 text-sm"
                />
              </div>
