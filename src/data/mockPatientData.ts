    ...
    clinical_notes: [
      {
        ...
        subjective: "Patient reports increasing dyspnea with moderate activities (climbing one flight of stairs). Orthopnea requiring 3 pillows. Weight gain of 2 kg in one week. Medication adherence reported as good.",
        objective: "BP 148/92, HR 88 bpm irregular, Temp 98.2 °F, SpO₂ 93% on RA. Bilateral basilar crackles. Bilateral LE edema 2+. JVD at 10 cm H₂O. S3 gallop at apex.",
        assessment: "Decompensated heart failure NYHA class III with rapid ventricular response atrial fibrillation. Volume overload.",
      ...
      },
      {
        ...
        subjective: "66-year-old male brought by ambulance for acute-onset dyspnea with anterior chest pain, non-radiating.",
        objective: "BP 165/100, HR 112 bpm irregular, SpO₂ 88% on RA, RR 28. Moderate respiratory distress. Diffuse bilateral crackles. ECG: rapid AFib, no ST elevation.",
        assessment: "Acute pulmonary edema secondary to HF decompensation. Rapid ventricular response AFib. Negative troponin — ACS ruled out.",
    ...
    clinical_notes: [
      {
        ...
        subjective: "Patient reports residual fatigue despite treatment. Weight gain of 3 kg over 3 months. Dry, brittle hair. Constipation.",
        objective: "BP 118/74, HR 62 bpm, Temp 97.5 °F. Thyroid palpable, homogeneous, non-tender. Dry skin. Slightly diminished deep tendon reflexes.",
        assessment: "Insufficiently treated hypothyroidism. TSH still elevated. Persistent iron deficiency anemia.",
    ...
    clinical_notes: [
      {
        ...
        subjective: "Patient's daughter reports worsening memory issues: missed meals, getting lost in the neighborhood. Residual left hip pain with walking. No falls since last visit.",
        objective: "BP 134/78, HR 72 bpm. MMSE 20/30 (orientation 7/10, recall 1/3). Timed Up and Go test: 18 seconds (fall risk). Left hip surgical scar well-healed. Satisfactory joint mobility.",
        assessment: "Progressive cognitive decline (moderate Alzheimer's). High fall risk. Good post-surgical recovery from femoral neck fracture.",
